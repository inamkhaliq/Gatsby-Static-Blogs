    ...
    return (
        <>
            <footer className="relative mt-20 bg-gray-900 px-4 pt-20">
                <div 
                    className=" mr-2 text-4xl text-cyan-500 absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-sky-500 bg-white p-2"
                >
                    <svg
                ...
                <p className="py-10 text-center text-gray-300">
                    © {new Date().getFullYear()} Mini Blogs | All Rights Reserved
                </p>
            </footer>
